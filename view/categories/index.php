<?php include "../layout/Header.php" ?>
    <a class="btn btn-info active" href="/MVC-OOP-PHP/view/categories/create-category.php" style="margin: 20px">Create categories</a>
...
//    echo "<br/>";
    $cat->deleteProd($connection, $_POST['delete']);
